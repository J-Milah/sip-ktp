    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="mb-1 mr-2">
                ...
                <a href="{{ route('cetakCreate') }}" class="btn btn-primary btn-sm">
                                            ...
                                            @foreach ($cetak as $item)
                                                <tr class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <!-- Edit Button -->
                                                        <a href="{{ route('cetakEdit', ['id' => $item->id, 'from' => 'Proses']) }}" class="btn btn-sm btn-warning">
                                                            <i class="fas fa-edit"></i>
                                                        </a>

                                                        <!-- Delete Button Trigger Modal -->
                                                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modalCetakDestroy{{ $item->id }}">
