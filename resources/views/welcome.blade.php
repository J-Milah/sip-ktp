...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="fade-up">
            <h1>SIP-KTP</h1>
            <p>Aplikasi Sistem Informasi Pencatatan KTP</p>
            <div class="d-flex">
              @auth
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out" data-aos-delay="100">
              <img src="{{ asset('enno/assets/img/logo-ktp1.png') }}" 
    ...
    <section id="about" class="about section">
      ...
      <div class="container section-title" data-aos="fade-up">
        ...
        <h2>UPT CAPIL BANJARMASIN BARAT</h2>
        <p>Unit Layanan Resmi Pemerintah Kota Banjarmasin</p>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12 content" data-aos="fade-up" data-aos-delay="200">
            <h3>UPT Capil Kecamatan Banjarmasin Barat merupakan unit layanan resmi Pemerintah Kota Banjarmasin </h3>
            <p class="fst-italic">
              yang bertugas 
              memberikan pelayanan administrasi kependudukan kepada masyarakat. 
              Kami berkomitmen untuk menghadirkan pelayanan yang cepat, transparan, dan mudah diakses oleh seluruh warga.
              Didukung oleh sumber daya manusia yang profesional, kami terus berupaya melakukan inovasi, termasuk melalui 
              penggunaan aplikasi SIP-KTP agar proses pelayanan menjadi lebih efektif dan efisien.
            </p>
            <ul>
              <li><i class="bi bi-check2-all"></i> <span>Memberikan pelayanan publik yang mudah, ramah, dan transparan</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Mengembangkan sistem pelayanan berbasis digital</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Menyediakan data kependudukan yang valid dan mutakhir</span></li>
              <li><i class="bi bi-check2-all"></i> <span>Meningkatkan kualitas layanan melalui SDM yang profesional</span></li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-xl-12">
            ...
            <div class="info-wrap">
              <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h3>Alamat</h3>
                  <p>Jl. Ir. P. Moch. Noor, Pelambuan, Kec. Banjarmasin Bar., Kota Banjarmasin, Kalimantan Selatan</p>
                </div>
              </div><!-- End Info Item -->

              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3983.125708673164!2d114.562309075841!3d-3.319094441228799!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2de42231446446bb%3A0x6606f7e99d8bb9e9!2sKantor%20Kecamatan%20Banjarmasin%20Barat!5e0!3m2!1sid!2sid!4v1764412005408!5m2!1sid!2sid" frameborder="0" style="border:0; width: 100%; height: 270px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Copyright</span> <strong class="px-1 sitename">SIP-KTP</strong> <span>All Rights Reserved</span></p>
      <div class="credits">
